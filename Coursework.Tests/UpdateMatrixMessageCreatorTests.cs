...
{
    [TestFixture]
    public class UpdateMatrixMessageCreatorTests
    {
        ...
        public void Setup()
        {
            ...
            _messageCreator = new UpdateMatrixMessageCreator(_networkMock.Object, _messageRouterMock.Object);
        ...
        [Test]
        public void GenerateShouldGenerateNewInitializeMessage()
        {
            // Arrange
            // Act
            ...
            Assert.That(firstMessage.MessageType, Is.EqualTo(MessageType.MatrixUpdateMessage));
            Assert.That(messages.All(m => m.ServiceSize == AllConstants.InitializeMessageSize));
