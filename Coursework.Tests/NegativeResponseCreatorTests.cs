...
{
    [TestFixture]
    public class NegativeResponseCreatorTests
    {
        ...
        public void Setup()
        {
            ...
            _messageCreator = new NegativeResponseCreator(_networkMock.Object, _messageRouterMock.Object);
        ...
        [Test]
        public void GenerateShouldGenerateNewNegativeResponse()
        {
            // Arrange
            ...
            Assert.That(firstMessage.MessageType, Is.EqualTo(MessageType.NegativeSendingResponse));
        ...
        [Test]
        public void GenerateShouldThrowExceptionIfMessageTypeIsNotNegativeResponse()
        {
            // Arrange
